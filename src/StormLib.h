...
#define MPQ_FLAG_ATTRIBUTES_INVALID 0x00000050  // If set, it means that the (attributes) has been invalidated
...
#define MPQ_KEY_HASH_TABLE          0xC3AF3660  // Obtained by HashString("(hash table)", MPQ_HASH_FILE_KEY)
#define MPQ_KEY_BLOCK_TABLE         0xEC83B4B3  // Obtained by HashString("(block table)", MPQ_HASH_FILE_KEY)
...
#define MPQ_HEADER_SIZE_V1    0x40 //0x20
...
TFileStream * FileStream_CreateFile(const TCHAR * szFileName, DWORD dwStreamFlags, LPBYTE pPassword = NULL);
TFileStream * FileStream_OpenFile(const TCHAR * szFileName, DWORD dwStreamFlags, LPBYTE pPassword = NULL);
...
bool   WINAPI SFileOpenArchive(const TCHAR * szMpqName, DWORD dwPriority, DWORD dwFlags, HANDLE * phMpq, LPBYTE pPassword = NULL);
bool   WINAPI SFileCreateArchive(const TCHAR * szMpqName, DWORD dwCreateFlags, DWORD dwMaxFileCount, HANDLE * phMpq, LPBYTE pPassword = NULL);
bool   WINAPI SFileCreateArchive2(const TCHAR * szMpqName, PSFILE_CREATE_MPQ pCreateInfo, HANDLE * phMpq, LPBYTE pPassword = NULL);
...
void WINAPI EncryptFileChunk(DWORD * MpqData, LPBYTE pbKey, ULONGLONG ByteOffset, DWORD dwLength);
void WINAPI DecryptFileChunk(DWORD * MpqData, const LPBYTE pbKey, ULONGLONG ByteOffset, DWORD dwLength);
...
int WINAPI AddSubFile_my(HANDLE hMpq, const char* pDir, const char* pFileName);

int WINAPI  CreateArchive_luascript(const char* pPlainName, const char* pScriptPath, int nMaxCount, LPBYTE pPassword = NULL);

int WINAPI OpenArchive_luascript(const char* pPlainName, LPBYTE pPassword = NULL, const char* pListFile = NULL);

TFileData * WINAPI LoadCertainFile(const char* pPackage, const char* pFileName, LPBYTE pPassword = NULL);

void WINAPI InitMyMpqScriptData(const char* path);
////////////////////////////////////////////////////////////////////////////////////////////////
